...
public class Client {
	...
	static LoungePanel loungePanel;
	...
	public Client() {
		...
		userList = clientFrame.getLoungePanel().getUserList();
		gameList = clientFrame.getLoungePanel().getGameList();
		mainMessageBox = clientFrame.getMessagePanel().getMainMessageBox();
		SelectButton1 = clientFrame.getLoungePanel().getSelectButton1();
		SelectButton2 = clientFrame.getLoungePanel().getSelectButton2();
		SelectButton3 = clientFrame.getLoungePanel().getSelectButton3();
		outRoomBtn = clientFrame.getLoungePanel().getOutRoomBtn();
		sendMessageBtn = clientFrame.getMessagePanel().getSendMessageBtn();
	}

	public void run() {
		clientFrame.getLoginPanel().clientData(ip, name, port);
...
//			clientFrame.setVisible(false);
	...
	private void connectToServer() throws IOException {
		try {
			...
			System.out.println(clientFrame.getLoginPanel().getIp());
